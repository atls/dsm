...
pub mod get_team_members {
    ...
    pub struct ResponseData {
        pub node: Option<GetTeamMembersNode>,
    }
    #[derive(Deserialize)]
    #[serde(tag = "__typename")]
    pub enum GetTeamMembersNode {
    ...
    #[derive(Deserialize)]
    pub struct GetTeamMembersNodeOnTeam {
        pub members: GetTeamMembersNodeOnTeamMembers,
    }
    #[derive(Deserialize)]
...
impl graphql_client::GraphQLQuery for GetTeamMembers {
    type Variables = get_team_members::Variables;
    type ResponseData = get_team_members::ResponseData;
    fn build_query(variables: Self::Variables) -> ::graphql_client::QueryBody<Self::Variables> {
        graphql_client::QueryBody {
            variables,
            query: get_team_members::QUERY,
            operation_name: get_team_members::OPERATION_NAME,
        }
    }
}
